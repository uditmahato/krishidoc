...
Color appPrimaryColor = primaryColor;
  const accent = Color(0xFFFBC02D);  // Yellow
 const background = Color(0xFFF5F5F5);
  const text = Color(0xFF212121);

const appSecondaryColor = Color(0xFFF68685);
const primaryDarkColor = Color.fromARGB(255, 3, 50, 52);
...
const textSecondaryWhiteColor = Color.fromARGB(255, 122, 124, 126);
